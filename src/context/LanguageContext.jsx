...
const en = {
  ...
  donatePage: {
    ...
    customAmountHint: 'Enter custom amount',
    ...
    bankTransferAlert: 'Please use the listed foundation bank accounts to donate securely.',
...
const fr = {
  ...en,
  nav: { ...en.nav, home: 'Accueil', about: 'A propos', inspiration: 'Inspiration', leadership: 'Direction', policies: 'Politiques', programs: 'Programmes', getInvolved: "S'impliquer", donate: 'Faire un don', resources: 'Ressources', news: 'Actualites', events: 'Evenements' },
...
const ha = {
  ...en,
  nav: { ...en.nav, home: 'Gida', about: 'Game da mu', inspiration: 'Ilhami', leadership: 'Jagoranci', policies: 'Dokoki', programs: 'Shirye-shirye', impact: 'Tasiri', getInvolved: 'Shiga tare da mu', donate: 'Ba da gudummawa', resources: 'Albarkatu', news: 'Labarai', events: 'Taro', contact: 'Tuntube mu' },
  ...
  impactPage: { ...en.impactPage, heroSubtitle: 'Wannan shafi yana mayar da hankali kan sakamako, hujjoji, da bayyanannun sakamakon aikin gidauniyar.', supportImpact: 'Tallafa wa wannan tasiri', evidenceTag: 'Takaitaccen hujja', evidenceTitle: 'Hoton isa da aiwatarwa na yanzu', changedTitle: 'Abin da ya canza', galleryTitle: 'Hotuna da bidiyoyi na gaske daga ayyuka', readDonate: 'Kara karatu kan gudummawa', downloadReportLabel: 'Zazzage rahoton misali', donate: 'Ba da gudummawa' },
...
const yo = {
  ...en,
  nav: { ...en.nav, home: 'Ile', about: 'Nipa wa', inspiration: 'Awokose', leadership: 'Asiwaju', policies: 'Eto imulo', programs: 'Awon eto', impact: 'Ipa', getInvolved: 'Darapo mo wa', donate: 'Se iranlowo', resources: 'Oro iranlowo', news: 'Iroyin', events: 'Awon isele', contact: 'Kan si wa' },
  ...
  donatePage: { ...en.donatePage, title: 'Se iranlowo', heroEyebrow: 'Se iranlowo', heroTitle: 'Atileyin re n se ayipada gidi', heroSubtitle: 'A se apeere oju-iwe iranlowo yii lati je ki fifunni rorun, kedere ati gbekele fun gbogbo alatilẹyin.', giveEyebrow: 'Se iranlowo loni', giveTitle: 'Yan bi o se fe se atileyin ise wa.', oneTime: 'Iranlowo lekan', monthly: 'Iranlowo ososu', chooseCurrency: 'Yan owo re', customAmountHint: 'Te iye tire sii', customLabel: 'Iye iranlowo tire', secureTitle: 'Awon ona isanwo to ni aabo', transparencyEyebrow: 'Otito', transparencyTitle: 'Ibi ti owo re n lo', donorEyebrow: 'Idaniloju oluranlowo', giveNow: 'Fun bayii', donateNow: 'Se iranlowo bayii', bankTransferAlert: 'Aaye isanwo to ni aabo n bo laipe.' },
...
const ig = {
  ...en,
  nav: { ...en.nav, home: 'Ulo', about: 'Banyere anyi', inspiration: 'Mkpali', leadership: 'Ndu', policies: 'Atumatu', programs: 'Mmemme', impact: 'Mmetuta', getInvolved: 'Soro sonye', donate: 'Nye onyinye', resources: 'Ihe enyemaka', news: 'Akuko', events: 'Ihe omume', contact: 'Kpotu anyi' },
  ...
  donatePage: { ...en.donatePage, title: 'Nye onyinye', heroEyebrow: 'Nye onyinye', heroTitle: 'Nkwado gi na-eweta mgbanwe n eziokwu', heroSubtitle: 'E mere ibe onyinye a iji mee ka inye onyinye di mfe, doo anya ma buru nke a puru itukwasi obi nye onye nkwado obula.', giveEyebrow: 'Nye onyinye taa', giveTitle: 'Horo otu i ga esi kwado ozi a.', oneTime: 'Onyinye otu ugboro', monthly: 'Onyinye kwa onwa', chooseCurrency: 'Horo ego gi', customAmountHint: 'Tinye ego nke gi', customLabel: 'Ego onyinye nke gi', secureTitle: 'Uzo ugwo echekwara', transparencyEyebrow: 'Nghota', transparencyTitle: 'Ebe ego gi na-aga', donorEyebrow: 'Nkwenye nye onye na enye onyinye', giveNow: 'Nye ugbu a', donateNow: 'Nye onyinye ugbu a', bankTransferAlert: 'Njiko ugwo echekwara na-abia n oge na-adighi anya.' },
...
const polishedCopyOverrides = {
  fr: {
    ...
    impactPage: {
      downloadReportLabel: 'Telecharger le rapport',
    },
    getInvolvedPage: {
      volunteerAlert:
  ...
  ha: {
    ...
    impactPage: {
      downloadReportLabel: 'Zazzage rahoton',
    },
    getInvolvedPage: {
      volunteerAlert:
  ...
  yo: {
    ...
    impactPage: {
      downloadReportLabel: 'Gba iroyin lati ayelujara',
    },
    getInvolvedPage: {
      volunteerAlert:
  ...
  ig: {
    ...
    impactPage: {
      downloadReportLabel: 'Budata akuko',
    },
    getInvolvedPage: {
      volunteerAlert:
