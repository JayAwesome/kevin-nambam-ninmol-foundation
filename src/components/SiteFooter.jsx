...
function SiteFooter() {
  ...
  const socialPlatforms = [
    { href: siteContact.socialLinks.facebook, label: 'Facebook' },
    { href: siteContact.socialLinks.instagram, label: 'Instagram' },
    { href: siteContact.socialLinks.x, label: 'X' },
    ...
    <footer className="site-footer">
      <div className="container footer-grid">
        ...
        <div>
          ...
          <p className="footer-text">{siteContact.registration}</p>
          {socialPlatforms.length ? (
            <div className="social-row">
              {socialPlatforms.map((platform) => (
                <IconLink key={platform.label} href={platform.href} label={platform.label}>
                  {platform.label === 'Facebook' ? (
