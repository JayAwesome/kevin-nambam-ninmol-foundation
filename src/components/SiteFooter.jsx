      ...
      <div className="container footer-grid">
        ...
        <div>
          ...
          <div className="social-row">
            <IconLink href={siteContact.socialLinks.facebook} label="Facebook">
              <svg viewBox="0 0 24 24" aria-hidden="true">
                <path d="M14 8h3V4h-3c-3.31 0-6 2.69-6 6v2H5v4h3v4h4v-4h4l1-4h-5v-2c0-1.1.9-2 2-2Z" />
              </svg>
            </IconLink>
            <IconLink href={siteContact.socialLinks.instagram} label="Instagram">
              <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <IconLink href={siteContact.socialLinks.x} label="X">
              <svg viewBox="0 0 24 24" aria-hidden="true">
