...
export const latestNews = [
  {
    slug: 'fear-no-fear-clinic-jos',
    title: 'Fear No Fear clinic expands youth mentoring in Jos',
    date: 'March 18, 2026',
    category: 'Programs',
    excerpt:
      'The foundation hosted a new basketball and mindset clinic that combined skills development with mentoring sessions.',
  },
  {
    slug: 'girl-child-leadership-session',
    title: 'Girl Child leadership session highlights confidence and opportunity',
    date: 'February 27, 2026',
    category: 'Education',
    excerpt:
      'Young girls participated in coaching, encouragement, and practical discussions on purpose, self-worth, and ambition.',
  },
  {
    slug: 'community-outreach-support-drive',
    title: 'Community outreach drive delivers practical support to vulnerable families',
...
export const blogPosts = [
  {
    slug: 'building-confidence-through-sport',
    title: 'Building confidence through sport',
    excerpt:
      'How basketball becomes a tool for resilience, discipline, and long-term mindset growth.',
    category: 'Insights',
    date: 'March 10, 2026',
  },
  {
    slug: 'why-girls-need-more-visible-opportunity',
    title: 'Why girls need more visible opportunity',
    excerpt:
      'The Girl Child Initiative is about practical support, self-belief, and space to lead.',
    category: 'Girl Child Initiative',
    date: 'February 15, 2026',
  },
  {
    slug: 'community-outreach-is-more-than-a-single-event',
    title: 'Community outreach is more than a single event',
    excerpt:
      'What long-term trust-building looks like when outreach is rooted in dignity and presence.',
    category: 'Community',
    date: 'January 21, 2026',
  },
  {
    slug: 'education-opens-the-second-door',
    title: 'Education opens the second door',
    excerpt:
      'Why scholarship support matters just as much as sports access in changing a young person’s future.',
    category: 'Education',
...
export const upcomingEvents = [
  {
    ...
    description:
      'A youth basketball clinic with mindset coaching, mentoring, and community engagement.',
  },
  {
    ...
    description:
      'A focused session on confidence, opportunity, and practical leadership for girls.',
  },
  {
    ...
    description:
      'A donor and partner engagement event for institutions, supporters, and strategic collaborators.',
  },
];
...
export const faqs = [
  {
    ...
    answer:
      'You can donate, volunteer, partner with us, or subscribe to receive updates on programs and opportunities.',
  },
  {
    question: 'Do you work only through basketball?',
    answer:
      'Basketball is a major tool, but our work also includes education support, mentorship, outreach, and life-skills development.',
  },
  {
